...
export default async function (app: FastifyInstance) {
    ...
    app.post('/token/settle-redemption', async (req) => {
    ...
    app.post('/token/flag-settlement-delayed', async (req) => {
        const body = z.object({
    ...
    app.get('/token/redemption-queue', async () => {
        const c = token as any;
    ...
    app.get('/token/redemption-request/:id', async (req) => {
